...
/// <summary>
/// No <c>iwex</c> block's base code may be a proper prefix of another's at a <c>-</c> boundary.
/// <para>
/// The idiom this protects is <c>SomeFamily.Code + "*"</c>, which several
/// <c>IwexCodes</c> selectors use to name "any member of this family" - including ones fed straight into
...
/// </para>
/// <para>
/// Found live: a naming pass briefly gave <c>iwex:mpenergy</c> (shaft + bevel) a code
