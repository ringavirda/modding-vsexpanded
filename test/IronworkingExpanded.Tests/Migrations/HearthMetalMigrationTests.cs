...
/// variant-grouped <c>iwex:hearthmetal-{pigiron|castiron}</c> with the metal in the code.
/// <para>
...
/// which reaches the same place through <see cref="SmexToIwexMigration"/> and is covered by
