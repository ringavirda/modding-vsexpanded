...
namespace IronworkingExpanded.Tests.Casting;

/// <summary>
/// The ceramic-tier ceiling decision (<see cref="ClayHeatGate.WouldShatter"/>): a small fired-clay tool
/// mold shatters when metal above <see cref="IwexValues.ClayMoldHeatCeiling"/> is poured into it. Large
/// tool molds (cast at iron temperatures in the tap) and our own cast-iron molds are exempt.
/// </summary>
public class ClayHeatGateTests
{
  ...
  {
    // Anvil / helve-hammer molds are cast from molten iron in the canal tap - gating them would make
    // anvil casting impossible.
