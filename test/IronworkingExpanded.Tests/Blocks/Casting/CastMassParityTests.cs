...
public class CastMassParityTests {
  private static readonly System.Reflection.Assembly Iwex =
  ...
  public void The_shell_came_back_to_iwex_and_ships_exactly_ONCE() {
    // `castshell` belongs to iwex because the ladle is built from it. A second definition in another
  ...
  public void Both_flywheel_grids_are_diagram_led_and_spend_four_then_eight_sections() {
    ...
    Assert.Equal(
      1,
      GlyphCount(grids[1], "iwex:diagram-mpenergy-flywheellarge")
    );
