...
/// which cells would accept an <c>iwex:furnace-chargepile</c>; both routes answer the same cells today and
...
public class ChargeableCellsTests {
  ...
  public void A_reverberatory_hearth_offers_no_chargeable_cell_at_all() {
    ...
    // domainless, hence implicitly `game:`, hence unable to admit `iwex:furnace-chargepile` - and that is
