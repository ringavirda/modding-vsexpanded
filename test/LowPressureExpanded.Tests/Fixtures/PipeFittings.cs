...
/// <c>lpex:pipe-passthrough-*</c> stays unsatisfied and the machine never completes - the same trap the
/// blast furnace hit with a generic pipe standing in for its tuyere.
/// <para>
/// Lives in the lpex suite because lpex owns the fittings; smex and hpex reach it through the
/// test-project chain.
/// </para>
/// </summary>
public static class PipeFittings
{
  ...
  /// <summary>
  /// A pipe passthrough - the brick-cased segment that carries a line <em>through</em> a structure
  /// wall, which is how cool blast air is fed into a cowper stove.
  /// </summary>
  ...
  // Type/Orientation the network code reads - the same priming PipeTestWorld.MakePipe does.
