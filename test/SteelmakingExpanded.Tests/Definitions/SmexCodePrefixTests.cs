...
/// <summary>
/// No <c>smex</c> block's base code may be a proper prefix of another's at a <c>-</c> boundary.
/// <para>
/// The idiom this protects is <c>SomeFamily.Code + "*"</c>, which several
/// <c>SmexCodes</c> selectors use to name "any member of this family" - including ones fed straight into
...
public class SmexCodePrefixTests
{
  ...
  private static readonly Assembly Mod = typeof(SteelmakingExpanded.SmexConfig).Assembly;
