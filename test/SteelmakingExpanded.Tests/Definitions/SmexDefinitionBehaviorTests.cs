...
/// <summary>
/// Behavioural (non-parity) checks on smex's code-first defs - beyond the byte-for-byte golden oracle
/// (<see cref="SmexDefinitionGoldenTests"/>): the two tall anchors' multiblock cell counts (a guard on the
/// ASCII layer DSL) and the smoke-stack deriving its orientation table from its own def.
/// </summary>
