...
public class ConverterChiselTests {
  ...
  private static TestWorld NewWorld() {
    ...
    world.RegisterItem("siex:ingot-bessemersteel", IronMelt);
  ...
  public void The_default_coefficient_halves_the_molten_cooldown_speed() {
    ...
    Assert.Equal(0.5f, SiexValues.BessemerCooldownCoefficient, 3);
    Assert.Equal(
  ...
  public void Changing_the_cooldown_coefficient_reaches_the_charge_already_in_the_vessel() {
    ...
    float original = SiexValues.BessemerCooldownCoefficient;
    try {
      // Cooling sped up mid-session.
      SiexValues.Edit(c => c.BessemerCooldownCoefficient = 10f);
      ...
      SiexValues.Edit(c => c.BessemerCooldownCoefficient = original);
    }
  }
  ...
  public void Status_tells_the_player_to_break_a_large_solidified_charge() {
    ...
    Assert.Equal("siex:bessemer-status-solidified", SolidifiedStatus(be));
  }
  ...
  public void Status_tells_the_player_to_wait_for_a_small_hot_residue_to_harden() {
    ...
    Assert.Equal("siex:bessemer-status-coolingtochisel", SolidifiedStatus(be));
  }
  ...
  public void Status_tells_the_player_to_chisel_a_small_hardened_residue() {
    ...
    Assert.Equal("siex:bessemer-status-chiselout", SolidifiedStatus(be));
  }
