...
/// <summary>
/// The converter vessel is a shell that mirrors the operational state pushed by its control block
/// and forwards the break handoff to it. Covers the mirror update, the control link and state
