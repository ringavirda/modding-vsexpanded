...
/// <summary>
/// The hot blast furnace in all four orientations, checked against the two oracles in iiex's
/// <see cref="FurnaceLayoutRig"/>. Only the hot furnace is covered here; the cold blast furnace, the
/// cupola and the tall-hopper exclusion run the same check on iiex types in that suite's matrix. The
