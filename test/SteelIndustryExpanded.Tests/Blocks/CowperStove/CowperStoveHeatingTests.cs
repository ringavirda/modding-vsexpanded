...
/// its connector face. Spanning siex (the regenerator) and iiex (the <see cref="PipeNetwork"/>), it
/// lives in the siex suite as the top mod of the two. Every case runs on a built
