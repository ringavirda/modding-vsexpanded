...
/// <summary>
/// Cowper-stove heat sink: a passive block entity that holds the regenerator temperature pushed in by
/// the stove and persists it. Covers the value semantics and the save/reload round trip; the
/// incandescent re-light is a client render concern.
/// </summary>
