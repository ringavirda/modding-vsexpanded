...
/// mold shatters when metal above <see cref="IiexValues.ClayMoldHeatCeiling"/> is poured into it. Large
/// tool molds (cast at iron temperatures in the tap) and iiex's cast-iron molds are exempt.
/// </summary>
public class ClayHeatGateTests {
  ...
  private static float Ceiling => IiexValues.ClayMoldHeatCeiling;
