...
public class ChargeCodeGateTests {
  ...
  private const string RemeltCode = "iiex:remeltburden";
  ...
  private const string PigCode = "iiex:pigchunk";
  ...
  // `iiex:remeltburden` is retired and must keep reading as "not burden".
