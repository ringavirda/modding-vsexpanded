...
**The goldens are the truth.** `mods/*/tests/goldens/*/blocktypes/**` is what actually ships; a copy here is a
...
layout move; see [blast-furnace-cold](../docs/design/machines/blast-furnace-cold.md).
...
**In C#** — `mods/iiex/src/BlockStructures/Furnaces/Blocks/BlockCrucibleFurnaceCore.cs`. One
...
**In C#** — `mods/iiex/src/BlockStructures/Furnaces/Blocks/BlockCokeOvenCore.cs`. A bank of two
...
1. ⛔⛔ **The `c` cells are firebox blocks, not `@(air|coalpile)`, and they carry `CellRole.Firebox`.**
   ...
   [coke-oven.md](../docs/design/machines/coke-oven.md).
...
completion monitor. See [boiler-cornish.md](../docs/design/machines/boiler-cornish.md).
...
[boiler-lancashire.md](../docs/design/machines/boiler-lancashire.md). Its own footprint:
...
direction, not a stale copy — see [blast-furnace-hot](../docs/design/machines/blast-furnace-hot.md) Open #2 for the four
...
* gas producer — **no layout exists at all**, and no `MultiblockLayout` in `mods/*/src/`
