...
/// block entity instantiates each by class code and, when it implements this interface, hands it the
/// principal's position and the cell's already-rotated connector face, so the behaviour orients itself
/// around the principal rather than the filler's own variant.
/// </summary>
...
/// <see cref="StructureFillers.FootprintCells"/>) and optional <see cref="Properties"/> passed through
/// to the behaviour. Stored on the filler block entity and recreated on load.
/// </summary>
