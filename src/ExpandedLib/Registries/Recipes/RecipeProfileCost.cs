...
/// profile is the complete cost picture of that recipe at that level. A grid recipe uses
/// <see cref="Ingredients"/> and optionally <see cref="Quantity"/>; an RCC construction uses
/// <see cref="Stages"/>. Fields not relevant to the recipe's kind are left null.
/// </summary>
public class RecipeProfileCost {
  ...
  /// (ingredient <c>name</c>, falling back to its code, → quantity).</summary>
