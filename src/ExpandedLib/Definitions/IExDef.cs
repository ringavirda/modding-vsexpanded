...
/// instead of three parallel copies of the same code.
/// </summary>
public interface IExDef
{
  ...
  /// <summary>The built definition JSON (a defensive clone) - a blocktype/itemtype <c>JObject</c> or a
  /// recipe-file array/object.</summary>
  JToken ToJson();
}
