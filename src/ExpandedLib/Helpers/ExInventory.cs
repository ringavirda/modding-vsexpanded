...
/// <summary>
/// Shared inventory queries for machine costs: counting and consuming player items that match a
/// predicate, over either the whole inventory or the hotbar only.
/// </summary>
