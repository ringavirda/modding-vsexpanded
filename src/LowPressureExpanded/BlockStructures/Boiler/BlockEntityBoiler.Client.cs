...
// Client side of the boiler: the in-vessel water-surface renderer, the client tick that
// keeps it fresh, and the steam/sound effects. Server state (_waterVolume, _state, ...)
// arrives via the synced tree; nothing here mutates it.
