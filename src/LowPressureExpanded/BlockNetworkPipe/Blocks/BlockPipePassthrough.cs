...
public partial class BlockPipePassthrough : BlockPipe, IChimneyVentable
{
  ...
  private static ExBlockDef Passthrough(string domain) =>
    Brick(domain, "pipes/passthrough", "*-passthrough-*-ns", "pipe-passthrough-*")
      ...
      .ShapeByType("*-passthrough-*-ns", "lpex:pipes/passthrough", rotateY: 0)
      .ShapeByType("*-passthrough-*-we", "lpex:pipes/passthrough", rotateY: 90)
      .ShapeByType("*-passthrough-*-ud", "lpex:pipes/passthrough", rotateX: 90);

  private static ExBlockDef PassthroughBend(string domain)
  {
    const string s = "lpex:pipes/passthroughbend";
    return Brick(
        domain,
