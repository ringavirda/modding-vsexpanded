...
public partial class BlockSteamCondenser : Block, INetworkConnector, IExBlockDefProvider
{
  ...
  private static ExBlockDef SteamCondenser(string domain) =>
    ExBlockDef
      .Create(domain, "steamcondenser", "pipes/steamcondenser")
      ...
      .CreativeTab("lpex", "*-north")
      .ShapeByType("*-north", "lpex:pipes/steamcondenser", rotateY: 0)
      .ShapeByType("*-east", "lpex:pipes/steamcondenser", rotateY: 270)
      .ShapeByType("*-south", "lpex:pipes/steamcondenser", rotateY: 180)
      .ShapeByType("*-west", "lpex:pipes/steamcondenser", rotateY: 90)
