...
public partial class BlockMoltenCanal : BlockNetworkNode, IExBlockDefProvider {
  ...
  private static ExBlockDef CanalDef(
    ...
    CanalFamilyDef(
        ...
        type.Orientations,
        type.FillQuads,
        $"iiex:molten/canal/{type.Type}",
        type.Shapes
      )
      .Class<BlockMoltenCanal>()
      .EntityClass("iiex.BlockEntityMoltenCanal");
  ...
  public override ItemStack[] GetDrops(
    ...
    if (world.BlockAccessor.GetBlockEntity(pos) is BlockEntityMoltenCanal be) {
      ...
      if (be.Sealed && world.GetItem(FireClayCode) is { } clay)
        ...
        [
          .. drops,
          new ItemStack(clay, IiexValues.CanalUnsealClayRefund),
        ];
    }
  ...
  /// <item>Straight canal + <see cref="IiexValues.CanalSealClayCost"/> fire clay:
  /// seals it into a flow-blocking separator.</item>
  /// <item>Sealed straight canal + chisel: breaks the seal and refunds
  /// <see cref="IiexValues.CanalUnsealClayRefund"/> fire clay.</item>
  /// </list>
  /// </summary>
  public override bool OnBlockInteractStart(
    ...
    if (!be.Sealed) {
      if (!IsFireClay(held) || held!.StackSize < IiexValues.CanalSealClayCost)
        return base.OnBlockInteractStart(world, byPlayer, blockSel);
      ...
      if (!CanSeal(world, blockSel.Position, be)) {
        if (world.Side == EnumAppSide.Server)
          (byPlayer as IServerPlayer)?.SendIngameError("iiex-canalnotempty");
        return false;
      }
      ...
      if (world.Side == EnumAppSide.Server) {
        ...
        if (byPlayer.WorldData.CurrentGameMode != EnumGameMode.Creative) {
          activeSlot!.TakeOut(IiexValues.CanalSealClayCost);
    ...
    if (world.Side == EnumAppSide.Server) {
      ...
      if (byPlayer.WorldData.CurrentGameMode != EnumGameMode.Creative) {
        ...
        if (clay != null) {
          var refund = new ItemStack(clay, IiexValues.CanalUnsealClayRefund);
  ...
  protected WorldInteraction? ChiselClearInteraction(
    ...
    world.BlockAccessor.GetBlockEntity(pos)
      ...
      ? MoltenChisel.ChiselHelp(world, "iiex:blockhelp-canal-clearsolidified")
      : null;
  ...
  public override WorldInteraction[] GetPlacedBlockInteractionHelp(
    ...
    if (be is { Sealed: true })
      ...
      [
        .. baseHelp,
        MoltenChisel.ChiselHelp(world, "iiex:blockhelp-canal-unseal"),
      ];
    ...
    if (be != null && CanSeal(world, selection.Position, be))
      ...
      [
        ...
        {
          ActionLangCode = "iiex:blockhelp-canal-seal",
  ...
  private static ItemStack[] ResolveFireClayStacks(IWorldAccessor world) {
    Item? clay = world.GetItem(FireClayCode);
    return clay != null
      ? [new ItemStack(clay, IiexValues.CanalSealClayCost)]
      : [];
  }
  #endregion
