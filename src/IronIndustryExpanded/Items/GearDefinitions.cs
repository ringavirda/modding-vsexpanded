...
/// <summary>
/// Itemtype definitions for iiex's craftable gears. Both use the vanilla <c>Item</c> class, so there is no
...
public class GearDefinitions : IExItemDefProvider {
  ...
  // steel-density material, and the general/items/iiex creative tabs.
