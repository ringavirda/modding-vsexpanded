...
public partial class BlockFirebox : Block, IExBlockDefProvider {
  ...
  public static IEnumerable<ExBlockDef> Definitions(string domain) =>
    [
      ExBlockDef
        ...
        .SideVariant()
        .ShapeByTypePerOrientation("iiex:furnace/firebox", 0)
        ...
        .Texture("cast-iron1", "iiex:block/metal/castiron")
  ...
  public override WorldInteraction[] GetPlacedBlockInteractionHelp(
    ...
    var help = new List<WorldInteraction>
    {
      new()
      {
        ActionLangCode = "iiex:firebox-help-charge",
        MouseButton = EnumMouseButton.Right,
      },
      new()
      {
        ActionLangCode = "iiex:firebox-help-take",
        MouseButton = EnumMouseButton.Right,
      },
    };
    if (
