...
/// <summary>
/// The iiex mold patterns: the wooden positives a sand mold is rammed around. Each is a variant of one
...
/// crafted from its diagram, a knife and a log, and wears with use. iiex ships its own <c>pattern</c>
...
public class PatternItemDefinitions : IExItemDefProvider {
  ...
  /// next to the shapes they were measured from. Public because iiex owns the pattern system - this helper,
  ...
  private static readonly Dictionary<string, string> PatternShapes = new() {
    ["castheavyplate"] = "iiex:item/heavyplate",
    ["castingotmold"] = "iiex:item/ingotmold",
    ["castbarrel"] = "iiex:item/cast-barrel",
    ["castwheelsection"] = "iiex:item/castwheelsection",
    ["castshell"] = "iiex:item/castshell",
    // The long-cell stock. Plural type names, singular shapes: the impression yields three billets, the
    // item is one billet.
    ["castbillets"] = "iiex:item/castbillet",
    ["castblooms"] = "iiex:item/castbloom",
    ["castslab"] = "iiex:item/castslab",
  };
  ...
  private static readonly Dictionary<string, object> Molds = new() {
    ["castheavyplate"] = Mold(
      "iiex:casting/cell-filling-heavyplate",
      CastPartItemDefinitions.HeavyPlateUnits,
      [Box(7, 4, 4, 9, 14, 12)],
      "iiex:castplate-heavy"
    ),
    ...
    ["castingotmold"] = Mold(
      "iiex:casting/cell-filling-ingotmold",
      152,
      [Box(3, 12, 3, 13, 14, 13)],
    ...
    ["castbarrel"] = Mold(
      "iiex:casting/cell-filling-moltenbarrel",
      CastPartItemDefinitions.CastBarrelUnits,
      [Box(4, 4, 4, 12, 12, 12)],
      "iiex:cast-barrel"
    ),
    // The cast shell: iiex owns it because the ladle is built from it, and iiex consumes it for the water
    ...
    // carries the mass.
    ["castshell"] = Mold(
      "iiex:casting/cell-filling-castshell",
    ...
    ["castwheelsection"] = Mold(
      ...
      "iiex:casting/cell-filling-flywheelpart",
      CastPartItemDefinitions.CastWheelSectionUnits,
      [Box(4, 10, 4, 12, 14, 12)],
    ...
    ["castbillets"] = Mold(
      "iiex:casting/longcell-filling-billets",
