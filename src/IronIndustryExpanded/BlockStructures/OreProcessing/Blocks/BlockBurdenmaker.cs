...
namespace IronIndustryExpanded.BlockStructures.OreProcessing.Blocks;
...
/// <c>iiex:</c> construction ingredient, which keeps it buildable in an iiex-only install.
...
public partial class BlockBurdenmaker
  ...
  /// so the code is <c>iiex:burdenmaker-{brick}-{side}</c>.
  /// </summary>
  public static IEnumerable<ExBlockDef> Definitions(string domain) =>
    [
      ExBlockDef
          ...
          c.Stage(s => s.AddElements("Root/Base"))
            ...
            .Stage(s =>
              s.Require(
                  ...
                  6,
                  "iiex:rcc-ingredient-hopperplate"
                )
            ...
            .Stage(s =>
              s.Require(
                  "game:metalplate-iron",
                  3,
                  "iiex:rcc-ingredient-lidplate"
                )
                .Require("game:ingot-iron", 2, "iiex:rcc-ingredient-lidrails")
        ...
        .CreativeTab("iiex", "*-cream-n")
        .ShapeSpunPerOrientation("iiex:ore/burdenmaker")
  ...
  // Public rather than internal: iiex declares no `InternalsVisibleTo`, so an internal classifier could
  ...
  private WorldInteraction[] BuildInteractionHelp(
    ...
    switch (cell) {
      case BurdenmakerCell.OreHopper:
        AddLoadHints(
          help,
          "iiex:burdenmaker-help-addore",
          "iiex:burdenmaker-help-addore-stack",
      ...
      case BurdenmakerCell.FluxHopper:
        AddLoadHints(
          help,
          "iiex:burdenmaker-help-addflux",
          "iiex:burdenmaker-help-addflux-stack",
      ...
      case BurdenmakerCell.Gate:
        help.Add(
          new WorldInteraction {
            ActionLangCode = "iiex:burdenmaker-help-gate",
    ...
    if (cell != BurdenmakerCell.Gate && cell != BurdenmakerCell.Outside)
      help.Add(
        new WorldInteraction {
          ActionLangCode = "iiex:burdenmaker-help-take",
          MouseButton = EnumMouseButton.Right,
        }
      );
