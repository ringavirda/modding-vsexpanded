...
namespace IronIndustryExpanded.BlockStructures.ManualPump.Blocks;
  ...
  public static IEnumerable<ExBlockDef> Definitions(string domain) =>
    [
      ExBlockDef
        ...
        .ShapeByTypePerOrientation("iiex:manualfluidpump", 0)
        .NonSolid(),
    ];
  ...
  private WorldInteraction[] InteractionHelp(
    ...
    help.Add(
      new WorldInteraction {
        ActionLangCode = "iiex:blockhelp-manualfluidpump-crank",
