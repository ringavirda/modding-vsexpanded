...
public partial class BlockSteamCondenser : Block, INetworkConnector, IExBlockDefProvider
{
  ...
  private static ExBlockDef SteamCondenser(string domain) =>
    ExBlockDef
      ...
      .CreativeTab("ppex", "*-north")
      .ShapeByType("*-north", "ppex:pipes/steamcondenser", rotateY: 0)
      .ShapeByType("*-east", "ppex:pipes/steamcondenser", rotateY: 270)
      .ShapeByType("*-south", "ppex:pipes/steamcondenser", rotateY: 180)
      .ShapeByType("*-west", "ppex:pipes/steamcondenser", rotateY: 90)
