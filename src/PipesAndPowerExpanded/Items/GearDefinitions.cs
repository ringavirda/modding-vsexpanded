...
namespace PipesAndPowerExpanded.Items;

/// <summary>
/// Code-first itemtype definitions for ppex's craftable gears (migrated from itemtypes/gear.json and
...
public class GearDefinitions : IExItemDefProvider
{
  ...
  // steel-density material, and the general/items/ppex creative tabs.
