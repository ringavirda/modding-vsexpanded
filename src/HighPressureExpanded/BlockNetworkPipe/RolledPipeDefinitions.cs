...
/// class itself lives in iwex: discovered when the hpex assembly is scanned, it injects
/// <c>hpex:pipe-*</c> blocktypes bound to the registered <c>iwex.BlockPipe</c> /
/// <c>iwex.BlockEntityPipe</c> classes.
/// <para>
