...
/// class lives in exlib: scanned from the hpex assembly, it injects <c>hpex:pipe-*</c> blocktypes
/// bound to the registered <c>exlib.BlockPipe</c> / <c>exlib.BlockEntityPipe</c> classes.
