      ...
      ExBlockDef
        ...
        .MultiblockLayout(s =>
          s.Origin(-1, 0)
            ...
            .Legend('I', SiexBlocks.CowperstoveIntake.Any)
            .Legend('P', IiexCodes.PipeOutlet)
            .Legend('X', IiexCodes.PipePassthroughAny)
            .Legend('H', SiexBlocks.CowperstoveHeatsink.Any)
        ...
        .SideVariant()
        .ShapeByType("*-intake-*-n", "siex:cowperstove/intake", rotateY: 0)
        .ShapeByType("*-intake-*-w", "siex:cowperstove/intake", rotateY: 90)
        .ShapeByType("*-intake-*-s", "siex:cowperstove/intake", rotateY: 180)
        .ShapeByType("*-intake-*-e", "siex:cowperstove/intake", rotateY: 270)
