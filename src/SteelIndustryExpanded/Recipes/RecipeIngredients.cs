...
namespace SteelIndustryExpanded.Recipes;

/// <summary>
/// Ingredient factories specific to this mod shared by more than one recipe provider. The vanilla staples
...
internal static class RecipeIngredients {
  ...
  internal static Func<IngredientBuilder, IngredientBuilder> PipeStar(
    int qty
  ) => i => i.Block("iiex:pipe-cast-straight*").Quantity(qty);
