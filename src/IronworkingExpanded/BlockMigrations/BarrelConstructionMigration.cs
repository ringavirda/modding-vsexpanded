...
/// <c>smex:moltenbarrel</c> - onto the current fabricated variant <c>iwex:molten-barrel-plated</c>, in one hop.
/// Both sides are the same <c>BlockEntityMoltenBarrel</c> class, so saved contents copy verbatim. Supersedes
/// the barrel's leg of <see cref="SmexToIwexMigration"/>, which no longer lists it.
/// <para>
