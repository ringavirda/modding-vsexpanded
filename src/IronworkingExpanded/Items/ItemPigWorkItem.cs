...
/// <summary>
/// The anvil work item a pig becomes while it is being helve-broken (<c>iwex:pigworkitem-iron</c>). A
...
/// <see cref="IronworkingExpanded.Patches.AnvilPigBreakingPatches"/> pays out as chunks and bits. Being a
