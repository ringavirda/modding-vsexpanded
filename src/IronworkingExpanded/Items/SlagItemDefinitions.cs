...
/// <summary>
/// Code-first itemtype definitions for iwex's slag by-products. All three use the vanilla <c>Item</c> class,
...
public class SlagItemDefinitions : IExItemDefProvider {
  ...
  /// <c>assets/iwex/config/metals/slag.json</c>); it is what tells a slag pour from a metal one.</summary>
  ...
  // Shared surface: a 64 stack, the slag texture, and the general and iwex creative tabs.
