...
/// run through a corner, a spur passes it straight on. Defined in iwex so the constructions that need it do
/// not reach for <c>lpex:gear-iron</c>, from a mod iwex takes no dependency on.
/// <para>
  ...
  public static IEnumerable<ExItemDef> Definitions(string domain) =>
    [
      ExItemDef
        ...
        // the Shape call becomes `iwex:item/gear-spur` and nothing else changes.
