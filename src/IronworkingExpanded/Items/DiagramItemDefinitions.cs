...
/// <c>docs/design/mechanics/diagram-crafting.md</c>. One <c>iwex:diagram</c> item with a <c>type</c>
/// variant over the plans iwex owns: pipes, molten canals, the tuyere, the casting bed and cell, the
