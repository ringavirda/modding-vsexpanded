...
/// live in exlib; discovered when the iwex assembly is scanned, it injects
/// <c>iwex:pipe-plated-*</c> segments and passthroughs bound to the
/// registered <c>exlib.BlockPipe</c> and <c>exlib.BlockEntityPipe</c> classes. The passthroughs are
/// plated-tier too: they bear no pressure, but lpex ships its own and without the axis the two would
