...
public class BlockEntityHopperBell : BlockEntity
{
  ...
  public int MaxMagazineCapacity => IwexValues.HopperMaxMagazineCapacity;
  ...
  private void OnServerTick(float dt)
  {
    ...
    int ironOreReq = IwexValues.HopperIronOreRequired;
    int cokeReq = IwexValues.HopperCokeRequired;
    int limeReq = IwexValues.HopperLimeRequired;
    int blastmixProd = IwexValues.HopperBlastmixProduced;
    int dropAmount = IwexValues.HopperDropAmount;
  ...
  public override void GetBlockInfo(IPlayer forPlayer, StringBuilder dsc)
  {
    ...
    dsc.AppendLine(
      Lang.Get(
        "iwex:hopper-info-bell",
        IsDropping
          ? Lang.Get("iwex:hopper-state-dropping")
          : Lang.Get("iwex:hopper-state-stopped")
      )
    );
    dsc.AppendLine(
      Lang.Get(
        "iwex:hopper-info-magazine",
        BlastMixMagazine,
        MaxMagazineCapacity
      )
    );
