...
/// <para>
/// <see cref="IwexValues.TwinTubBlowerMaxPressure"/> sits above the demand of a coke-rich burden and below
...
public class BlockEntityTwinTubMPBlower : BlockEntityPipe {
  ...
  /// <see cref="IwexValues.TwinTubBlowerMinSpeed"/> or the line is at the pressure ceiling. Public so the
  ...
  /// <see cref="IwexValues.TwinTubBlowerMinSpeed"/>, 1 at or above
  /// <see cref="IwexValues.TwinTubBlowerMaxSpeed"/>, linear between.
  /// </summary>
    ...
    dsc.AppendLine(
      fraction <= 0f
        ...
        : Lang.Get(
          ...
          ExMeasure.FlowRate(
            IwexValues.TwinTubBlowerOutputPerSecond * fraction
          ),
          (int)(fraction * 100f)
        )
    );
