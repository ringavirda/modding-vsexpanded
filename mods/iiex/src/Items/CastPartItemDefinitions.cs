...
/// machine. These parts are iiex's and iiex consumes them; <c>castframe</c> is iiex's and has no row here.
...
public class CastPartItemDefinitions : IExItemDefProvider {
  ...
  private const string CastIron = "iiex:block/metal/castiron";
  ...
  private static ExItemDef CastWheelSection(string domain) =>
    ExItemDef
      ...
      .Shape("iiex:item/castwheelsection")
      .MaxStackSize(16)
      .MaterialDensity(7200)
      .CombustibleProps(new { meltingPoint = 1150 })
