...
public partial class BlockMoltenBarrel : Block, IExBlockDefProvider {
  ...
  public static IEnumerable<ExBlockDef> Definitions(string domain) =>
    [
      ExBlockDef
        ...
        .EntityClass("iiex.BlockEntityMoltenBarrel")
        ...
        .ShapeByType("*-plated", "iiex:molten/barrel-plated")
        .ShapeByType("*-cast", "iiex:molten/barrel-cast")
        .NonSolid()
  ...
  public override void GetHeldItemInfo(
    ...
    if (currentUnits <= 0) {
      dsc.AppendLine(Lang.Get(IiexLang.MoltenbarrelInfoEmpty, maxUnits));
      return;
    }

    if (metalContent == null) {
      dsc.AppendLine(
        Lang.Get(IiexLang.MoltenbarrelInfoUnits, currentUnits, maxUnits)
      );
      return;
    }
    ...
    dsc.AppendLine(
      Lang.Get(
        "iiex:moltenbarrel-info-content",
        currentUnits,
        maxUnits,
  ...
  public override WorldInteraction[] GetPlacedBlockInteractionHelp(
    ...
    var result = new List<WorldInteraction>(interactions)
    {
      new()
      {
        ActionLangCode = "iiex:blockhelp-barrel-pickup",
    ...
    if (!isHardened && !isFull) {
      result.Add(
        new WorldInteraction {
          ActionLangCode = "iiex:blockhelp-barrel-pour",
          MouseButton = EnumMouseButton.Right,
    ...
    if (isHardened)
      result.Add(
        MoltenChisel.ChiselHelp(world, "iiex:blockhelp-barrel-chisel")
      );
