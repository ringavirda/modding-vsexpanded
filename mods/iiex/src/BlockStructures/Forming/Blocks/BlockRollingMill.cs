...
public partial class BlockRollingMill
  ...
  private static bool FitRollSet(
    ...
    if (!mill.TryFitRollSet(fitting, out ItemStack? previous)) {
      ...
      slot.MarkDirty();
      (byPlayer as IServerPlayer)?.SendIngameError("iiex-rollingmill-busy");
      return true;
    }
  ...
  private bool Feed(
    ...
    (byPlayer as IServerPlayer)?.SendIngameError(
      decision.Verdict switch {
        FeedVerdict.NoRollSet => "iiex-rollingmill-norollset",
        FeedVerdict.WrongForm => "iiex-rollingmill-wrongform",
        FeedVerdict.NoReduction => "iiex-rollingmill-noreduction",
        FeedVerdict.TooCold => "iiex-rollingmill-toocold",
        FeedVerdict.PartCropped => "iiex-rollingmill-partcropped",
        _ => "iiex-rollingmill-wontbite",
      }
    );
    return true;
  }
  ...
  public WorldInteraction[] GetFillerInteractionHelp(
    ...
    [
      ...
      {
        ActionLangCode = "iiex:rollingmill-help-feed",
        MouseButton = EnumMouseButton.Right,
      },
      new WorldInteraction
      {
        ActionLangCode = "iiex:rollingmill-help-feed-far",
        MouseButton = EnumMouseButton.Right,
        HotKeyCode = "sneak",
      },
      new WorldInteraction
      {
        ActionLangCode = "iiex:rollingmill-help-free",
        MouseButton = EnumMouseButton.Right,
        Itemstacks = [],
      },
    ];
