      ...
      Core(
        ...
        .MultiblockLayout(s =>
          ...
          s.Origin(-6, -1)
            ...
            // The firebars are part of `iiex:furnace-firebox`, so no separate grating cell sits under
            ...
            .Legend('C', IiexBlocks.FurnacePuddlingcore.Any)
            .Legend(
              'H',
              IiexBlocks.FurnacePuddlinghearth.WithSide(BlockFacing.NORTH)
            )
            .Legend(
              'D',
              IiexBlocks.FurnacePuddlingchargedoor.WithSide(BlockFacing.SOUTH)
            )
            .Legend(
              'M',
              IiexBlocks.FurnacePuddlingchimneycap.WithSide(BlockFacing.NORTH)
            )
