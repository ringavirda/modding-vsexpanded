  ...
  public static new IEnumerable<ExBlockDef> Definitions(string domain) =>
    [
      ExBlockDef
        ...
        .ShapeByType("*-e", "iiex:furnace/twintubmpblower", rotateY: 90)
        .ShapeByType("*-s", "iiex:furnace/twintubmpblower", rotateY: 180)
        .ShapeByType("*-w", "iiex:furnace/twintubmpblower", rotateY: 270)
        .CreativeCommon("*-n")
        .FillerOffsets(
