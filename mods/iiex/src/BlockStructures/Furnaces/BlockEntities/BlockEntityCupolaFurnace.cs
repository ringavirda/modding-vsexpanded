...
/// <c>Cupola*</c> tunables (see <see cref="IiexConfig"/>). See docs/design/machines/cupola.md.
/// </summary>
[BlockEntityRegister]
public class BlockEntityCupolaFurnace : BlockEntityShaftFurnace {
  ...
  public override int ChargeUnitsPerBlock =>
    IiexValues.CupolaChargeMetalUnitsPerBlock;
  ...
  protected override string MoltenProductInfoLangKey =>
    IiexLang.CupolaInfoMoltencastiron;

  protected override AssetLocation SolidProductBlock { get; } =
    new("iiex", "hearthmetal-castiron");
  ...
  protected override float TuyereIntakeVolume =>
    IiexValues.CupolaTuyereIntakeVolume;
  ...
  /// fraction and <see cref="IiexValues.BfIronPerOreUnit"/>, a reduction yield, does not apply. The two
  ...
  protected override float ProductPerUnit(BurdenMix mix) =>
    IiexValues.CupolaCastIronPerMeltCycle
    / Math.Max(1, IiexValues.CupolaBlastMixPerMeltCycle);

  protected override float SlagPerUnit(BurdenMix mix) =>
    IiexValues.CupolaSlagPerMeltCycle
    / Math.Max(1, IiexValues.CupolaBlastMixPerMeltCycle);
