...
/// <summary>
/// The selector-coverage rule (<see cref="SelectorCoverage"/>) over iiex's own golden blocktypes.
/// </summary>
public class EmittedBlocktypeShapeTests {
  [Fact]
  public void Every_block_variant_resolves_a_shape() {
    var findings = new List<string>();
    foreach (string path in SelectorCoverage.GoldenBlocktypes("iiex"))
  ...
  public void The_golden_corpus_is_not_empty() {
    ...
    Assert.NotEmpty(SelectorCoverage.GoldenBlocktypes("iiex"));
  }
}
