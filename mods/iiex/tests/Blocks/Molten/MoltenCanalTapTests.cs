...
public class MoltenCanalTapTests {
  ...
  private static TestWorld NewWorld() {
    ...
    world.Register(TestBlocks.Configure(new Block(), "iiex:molten-barrel", 50));
    return world;
  }
  ...
  public void AddBarrel_adopts_the_stacks_metal_and_capacity() {
    ...
    var barrelStack = new ItemStack(
      world.World.GetBlock(new AssetLocation("iiex:molten-barrel"))
    );
    ...
    Assert.Equal(IiexValues.BarrelDefaultMaxUnits, be.BarrelMaxUnits);
