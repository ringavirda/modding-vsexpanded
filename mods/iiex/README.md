...
that mechanises it. It sits directly on [Expanded Library](../exlib/README.md) and is a
hard dependency of [Steel Industry Expanded](../siex/README.md).
...
Depends on [Expanded Library](../exlib/README.md) (`exlib`) for the block-network,
...
dotnet build mods/iiex/src/IronIndustryExpanded.csproj
```
