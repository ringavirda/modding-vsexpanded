...
public partial class BlockConverterControl : Block, IExBlockDefProvider {
    ...
    ExBlockDef
      ...
      .Multiblock(m =>
        m.Number("siex:convertercontrol*", 1)
          ...
          .Number("siex:converter-intake*", 4)
      ...
      .SideVariant()
      .ShapeByType("*-n", "siex:converter/control", rotateY: 0)
      .ShapeByType("*-e", "siex:converter/control", rotateY: 270)
      .ShapeByType("*-s", "siex:converter/control", rotateY: 180)
      .ShapeByType("*-w", "siex:converter/control", rotateY: 90)
      .SideSolid(false)
      .SideOpaque(false);
  ...
  public override bool OnBlockInteractStep(
    ...
    if (secondsUsed < SiexValues.BessemerPourHoldSeconds)
  ...
  public override WorldInteraction[] GetPlacedBlockInteractionHelp(
      ...
      return baseHelp
        .Append(
          new WorldInteraction {
            ActionLangCode = "siex:blockhelp-bessemer-spawn",
    ...
    return baseHelp
      .Append(
        new WorldInteraction {
          ActionLangCode = "siex:blockhelp-bessemer-normal",
          MouseButton = EnumMouseButton.Right,
        }
      )
      .Append(
        new WorldInteraction {
          ActionLangCode = "siex:blockhelp-bessemer-filling",
          HotKeyCodes = ["sneak"],
          MouseButton = EnumMouseButton.Right,
        }
      )
      .Append(
        new WorldInteraction {
          ActionLangCode = "siex:blockhelp-bessemer-pouring",
          HotKeyCodes = ["sprint"],
          MouseButton = EnumMouseButton.Right,
        }
      )
      .Append(
        new WorldInteraction {
          ActionLangCode = "siex:blockhelp-bessemer-scrap",
          MouseButton = EnumMouseButton.Right,
