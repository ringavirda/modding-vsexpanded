  ...
  public static IEnumerable<ExBlockDef> Definitions(string domain) =>
    [
      ExBlockDef
        ...
        .EntityClass<BlockEntityConverterTransmission>()
        .EntityBehavior<BEBehaviorMPConverterTransmission>()
        ...
        .SideVariant()
        .ShapeByTypePerOrientation("siex:converter/transmission", offset: 180)
        .NonSolid(),
    ];
