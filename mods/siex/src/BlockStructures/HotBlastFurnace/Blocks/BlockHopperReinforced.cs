...
public partial class BlockHopperReinforced : Block, IExBlockDefProvider {
  ...
  public static IEnumerable<ExBlockDef> Definitions(string domain) =>
    [
      ExBlockDef
        ...
        .EntityClass<BlockEntityHopperReinforced>()
        .CreativeCommon("*")
        .Material(EnumBlockMaterial.Metal)
        .MaxStackSize(1)
        .LightAbsorption(0)
        .Shape("siex:blastfurnace/hopper-reinforced")
        .NonSolid()
        .Resistance(1.75f)
        .MetalSounds(),
    ];
  ...
  public override WorldInteraction[] GetPlacedBlockInteractionHelp(
    ...
    var help = new List<WorldInteraction>
    {
      new()
      {
        ActionLangCode = "siex:blockhelp-hopper-add",
        MouseButton = EnumMouseButton.Right,
        Itemstacks = burden,
      },
      new()
      {
        ActionLangCode = "siex:blockhelp-hopper-addstack",
        MouseButton = EnumMouseButton.Right,
        HotKeyCode = "ctrl",
        Itemstacks = burden,
      },
    ...
    if (
      ...
      help.Add(
        new WorldInteraction {
          ActionLangCode = "siex:blockhelp-hopper-take",
          MouseButton = EnumMouseButton.Right,
        }
      );
    ...
    if (
      ...
      help.Add(
        new WorldInteraction {
          ActionLangCode = "siex:blockhelp-hopper-toggle",
          HotKeyCodes = ["ctrl"],
          MouseButton = EnumMouseButton.Right,
        }
      );
