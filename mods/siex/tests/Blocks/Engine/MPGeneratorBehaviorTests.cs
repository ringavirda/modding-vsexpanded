...
/// <summary>
/// The MP-generator sub-machine's mechanical-power behavior, a constant-power torque source. It turns
/// the engine's <see cref="BlockEntityEngine.MpPowerBudget"/> into network torque (the budget at rated
/// speed, more torque as the shaft slows, tapering to zero past a soft speed cap), and cuts its power
/// demand when the load overstresses the engine.
/// </summary>
