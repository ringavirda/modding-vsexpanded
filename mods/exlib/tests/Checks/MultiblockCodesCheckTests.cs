...
public class MultiblockCodesCheckTests {
  ...
  public void A_star_segment_matches_any_single_segment_in_that_position() {
    ...
    Assert.True(MultiblockCodesCheck.AnyProvides(registered, "furnace-blastcore-*-n"));
    Assert.False(MultiblockCodesCheck.AnyProvides(registered, "furnace-blastcore-*-s"));
  }

  [Fact]
  public void Two_star_segments_each_match_independently() {
    var registered = new HashSet<string> {
      "furnace-firebox-tier2-w",
    };

    Assert.True(MultiblockCodesCheck.AnyProvides(registered, "furnace-firebox-*-*"));
  }
  ...
  public void A_glued_star_matches_by_prefix_within_one_segment() {
    ...
    Assert.True(MultiblockCodesCheck.AnyProvides(registered, "convertercontrol*"));
    Assert.False(MultiblockCodesCheck.AnyProvides(registered, "convertertransmission*"));
  }
  ...
  public void A_trailing_wildcard_segment_still_matches_a_bare_registered_code() {
    ...
    Assert.True(MultiblockCodesCheck.AnyProvides(registered, "furnace-tuyere-*"));
  }
}
