...
/// asset - including one carrying a key the type does not declare - is reported and skipped so one bad
/// file does not fail the whole load.
/// </summary>
internal static class AssetCatalogueLoader {
  /// <summary>
