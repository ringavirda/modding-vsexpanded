...
| the fastener placement rule (nails and bolts are iron, rivets are steam) | [STATE.md § Fasteners](../../internal/plans/STATE.md) |
...
[density rule](../mechanics/density-rule.md) · [STATE.md § Fasteners](../../internal/plans/STATE.md)
...
| hardened die sets are one of crucible steel's four named consumers | [STATE.md § D9](../../internal/plans/STATE.md) |
