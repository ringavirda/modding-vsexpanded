...
| the fastener placement rule (nails and bolts are iron, rivets are steam) | [STATE.md § Fasteners](../../plans/STATE.md) |
...
[density rule](../mechanics/density-rule.md) · [STATE.md § Fasteners](../../plans/STATE.md)
...
machine made bolts, the die being the whole difference ([STATE.md § Fasteners](../../plans/STATE.md)). One
...
| hardened die sets are one of crucible steel's four named consumers | [STATE.md § D9](../../plans/STATE.md) |
