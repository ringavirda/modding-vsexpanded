...
* the audit of the four shipped metal defs against the ladder - including that `bessemersteel.json` ships
  `tools: {preset:"good"}` against [N1](../../../../docs/superpowers/plans/STATE.md);
...
| pipe network pressure, burst, R1 single medium | [pipe network](https://github.com/ringavirda/exlib/blob/main/docs/design/mechanics/pipe-network.md), [cast pipes](../machines/cast-pipes.md), [rolled pipe](../machines/rolled-pipe.md) |
| `IMoltenCell`, `FlowEdge`, the metal-type refusal, the no-op merge | [molten network](https://github.com/ringavirda/exlib/blob/main/docs/design/mechanics/molten-network.md) |
...
| status of everything, D1–D9, N1–N3, the blocker list | [STATE.md](../../../../docs/superpowers/plans/STATE.md) |

**Depends on** [density rule](../mechanics/density-rule.md) · [molten network](https://github.com/ringavirda/exlib/blob/main/docs/design/mechanics/molten-network.md) ·
...
[bearings](../machines/bearings.md) · [STATE.md](../../../../docs/superpowers/plans/STATE.md)
...
([D8](../../../../docs/superpowers/plans/STATE.md)); non-ferrous (copper, the bronzes, pure copper) is deferred and has no row here.
...
Settled ([STATE.md § D3](../../../../docs/superpowers/plans/STATE.md)):
...
1. **`bessemersteel.json` ships a full tool family, against N1.** `generateItemFamily: true`,
   ...
   forge. [N1](../../../../docs/superpowers/plans/STATE.md) (the blow yields blown iron, not steel) and the ladder's own rule (tools
