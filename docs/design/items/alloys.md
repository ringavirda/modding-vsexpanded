...
* the audit of the four shipped metal defs against the ladder - including that `bessemersteel.json` ships
  `tools: {preset:"good"}` against [N1](../../../../docs/plans/STATE.md);
...
| status of everything, D1–D9, N1–N3, the blocker list | [STATE.md](../../../../docs/plans/STATE.md) |
...
[bearings](../machines/bearings.md) · [STATE.md](../../../../docs/plans/STATE.md)
...
([D8](../../../../docs/plans/STATE.md)); non-ferrous (copper, the bronzes, pure copper) is deferred and has no row here.
...
Settled ([STATE.md § D3](../../../../docs/plans/STATE.md)):
...
1. **`bessemersteel.json` ships a full tool family, against N1.** `generateItemFamily: true`,
   ...
   forge. [N1](../../../../docs/plans/STATE.md) (the blow yields blown iron, not steel) and the ladder's own rule (tools
