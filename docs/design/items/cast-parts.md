...
| the D2 / N3 decision itself (cast ↔ fabricated substitution) | [STATE.md](../../plans/STATE.md) |
...
[rolled parts](rolled-parts.md) · [STATE.md](../../plans/STATE.md)
...
cupola, fabricate with a mill ([STATE.md § D2](../../plans/STATE.md)). That is what gives cheap Bessemer
...
[STATE.md § D2 / § N3](../../plans/STATE.md)'s; the bending verb and the machine are
...
fabricated frame costs rivets ([STATE.md § N3](../../plans/STATE.md)). Rivets do not exist yet - see
