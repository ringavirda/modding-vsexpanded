...
[STATE.md § N1](../../../../docs/superpowers/plans/STATE.md), [Bessemer § Open 1](../machines/bessemer.md#open) and
...
| `IMoltenCell`, `FlowEdge`, the metal-type refusal, push/drain/soak | [molten network](https://github.com/ringavirda/exlib/blob/main/docs/design/mechanics/molten-network.md), [molten canal](../machines/molten-canal.md) |
...
| status of everything, N1, D4 | [STATE.md](../../../../docs/superpowers/plans/STATE.md) |

**Depends on** [Bessemer](../machines/bessemer.md) · [ladle](../machines/ladle.md) · [alloys](alloys.md) ·
[molten network](https://github.com/ringavirda/exlib/blob/main/docs/design/mechanics/molten-network.md) · [recoverability](../mechanics/recoverability.md) ·
[STATE.md § N1](../../../../docs/superpowers/plans/STATE.md)
...
The settled chain ([STATE.md § N1](../../../../docs/superpowers/plans/STATE.md)):
...
| product of a settled 6000 u charge | 5400 u | [Bessemer](../machines/bessemer.md#numbers), [STATE.md § D4](../../../../docs/superpowers/plans/STATE.md) |
| recarburiser demanded per heat | ~300 u of FeMn | [STATE.md § the ferroalloy furnace](../../../../docs/superpowers/plans/STATE.md) |
...
6. The metal-type refusal makes a mistake permanent. `FlowEdge` will not move metal into a cell holding a
   different code and the graph's merge is a no-op ([molten network](https://github.com/ringavirda/exlib/blob/main/docs/design/mechanics/molten-network.md)), so
...
3. How much ferromanganese per heat, and does it change the mass balance? ~300 u is
   [STATE.md](../../../../docs/superpowers/plans/STATE.md)'s estimate against a 5400 u heat (≈ 5.5 %). FeMn is high-carbon by
