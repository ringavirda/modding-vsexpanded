...
| | |
|---|---|
| [plans/STATE.md](../plans/STATE.md) | what is actually true right now - live vs designed vs blocked, every blocker with code evidence, and the open decisions. Read before trusting any page's status |
