...
| Current build status and every open decision (the D/N rulings, the blocker list) | [STATE.md](../plans/STATE.md) |
| The mod chain, the pillars, the build order | [overview.md](overview.md) |

**Depends on** [overview.md](overview.md) · [STATE.md](../plans/STATE.md) · [conventions.md](conventions.md) ·
...
Decision D8 ([STATE.md](../plans/STATE.md)). Deferred later, not to Homestead: this is period-correct
