...
[STATE.md](../../plans/STATE.md) - D3, D6, D8, N2
...
| copper / bronze | no | available - deferred with all non-ferrous ([STATE.md](../../plans/STATE.md) D8) |
...
> D3 ([STATE.md](../../plans/STATE.md)): alloys inherit their base's properties as a continuous penalty, not
...
| HSS | open-hearth | ~18 % W + ~4 % Cr | tungsten has no source anywhere - the ferroalloy family is FeMn / FeCr / FeSi ([STATE.md](../../plans/STATE.md)) | no - elex, deferred (D8) |
