...
**Status** blocked - designed, nothing exists. The step is mandatory under [STATE.md](../../plans/STATE.md) N1
...
use it) · [conventions.md](../conventions.md) - R2, R3, R5, R7 · [STATE.md](../../plans/STATE.md) - N1, D4, D6
...
process work at all, and the mod treats it that way ([STATE.md](../../plans/STATE.md) N1).
...
|---|---|---|
| **Bessemer blown iron** | mandatory | the blow has no stopping point that leaves a usable metal ([STATE.md](../../plans/STATE.md) N1) |
| **Over-blown ingot iron** | yes | [alloys](../items/alloys.md) already routes it - *"not wrought iron — recarburise or remelt"* |
| **Arc-furnace ingot iron** | yes, when elex exists | same row; deferred with elex ([STATE.md](../../plans/STATE.md) D8) |
