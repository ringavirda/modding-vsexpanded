...
| A multiblock offset table is a coordinate pyramid nobody can read | ASCII layer diagrams, validated at build - `ExBlockDef.cs:796`, see [multiblock](https://github.com/ringavirda/exlib/blob/main/docs/design/mechanics/multiblock.md) |
...
| `HighPressureExpanded.Tests` | 7 | `mods/siex/tests/goldens/siex/` |
