...
**Depends on** [multiblock & filler structures](multiblock.md) (the ASCII layout DSL `ExBlockDef.MultiblockLayout` / `.FillerOffsets` feed, and the RCC-built mega-blocks that carry construction stages) · [repo status](../../plans/STATE.md)
