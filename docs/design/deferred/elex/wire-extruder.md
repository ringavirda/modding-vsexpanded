# Wire extruder
**Status** deferred   **Would live in** `elex` (Electrical Expanded — no project, no asset domain, no code)   **Deferred by** **D7** ([STATE.md](../../../plans/STATE.md)) — *"Wire. Exists, in elex."* — and with the mod, by **D8**
...
|---|---|
| Which tier? | elex — **D7** ([STATE.md](../../../plans/STATE.md)) |
