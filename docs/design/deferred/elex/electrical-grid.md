...
domain and no code   **Deferred by** D8 ([STATE.md](../../../../../docs/superpowers/plans/STATE.md)) - the release target is the
...
([STATE.md](../../../../../docs/superpowers/plans/STATE.md)) wire lives in elex, which is what puts it on this table at all.
