# Electrolysis cell
**Status** deferred   **Would live in** `elex` (Electrical Expanded — no project, no asset domain, no code)   **Deferred by** **D8** ([STATE.md](../../../../../docs/superpowers/plans/STATE.md), release target = the ferrous line) **and again by D8's non-ferrous half** ([scope](../../scope.md) § Non-ferrous) — this is a *copper* machine
...
|---|---|---|
| elex is off the release path | D8 ([STATE.md](../../../../../docs/superpowers/plans/STATE.md)) - release target is the ferrous line | defers the whole mod, this block included |
