...
a mod. See § Open.
**Deferred by** D8 - non-ferrous is later ([STATE.md](../../../../../docs/superpowers/plans/STATE.md)); the cut and its reasoning
...
7. Throughput and capacity. No number is proposed anywhere. The canal start holds 100 u
   ...
   [STATE.md](../../../../../docs/superpowers/plans/STATE.md)); nothing says what one tilt is worth.
