...
steel is and which parts require it · [STATE.md](../../plans/STATE.md) - D3, D6, the blocker list
...
6. HSS feedstock is open-hearth-exclusive ([materials.md](../materials.md)) and elex is out of scope
   ([STATE.md](../../plans/STATE.md) D8). So one of this machine's three stated jobs has no consumer in the
