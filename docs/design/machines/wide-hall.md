...
| the prime mover | vanilla waterwheel at iron tier, replaced by a steam engine in iiex | [STATE.md](../../../../docs/superpowers/plans/STATE.md) |
...
(`BlockEntityRollingMill.cs:250-260` vs `MillFeed.cs:78-89`; [STATE.md](../../../../docs/superpowers/plans/STATE.md)) - therefore
