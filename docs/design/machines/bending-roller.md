...
| the energy model, `IMpEnergyConsumer`, the pulsed-load argument, every `Mp*` key | [mp-energy](../mechanics/mp-energy.md) |
...
| drive headroom one bridged waterwheel leaves | ≈ 0.4 N·m | [mp-energy](../mechanics/mp-energy.md), via [rolling mill](rolling-mill.md) § Worked pass |
