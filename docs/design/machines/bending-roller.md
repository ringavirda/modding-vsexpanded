...
([STATE.md:429-434](../../../../docs/superpowers/plans/STATE.md)).
...
| the fabricated-substitute decision (D2 / N3) and the placement rule | [STATE.md](../../../../docs/superpowers/plans/STATE.md) |
...
[recipes & config](../mechanics/recipes-config.md) · [STATE.md § N3](../../../../docs/superpowers/plans/STATE.md) ·
...
operation, not a variant of the same one ([STATE.md:446-448](../../../../docs/superpowers/plans/STATE.md)).
...
the overload the roll-set idiom exists to avoid ([STATE.md:450-453](../../../../docs/superpowers/plans/STATE.md)).
...
([STATE.md:455-456](../../../../docs/superpowers/plans/STATE.md)).
...
> ([STATE.md:440-442](../../../../docs/superpowers/plans/STATE.md)).
...
operations, and only bending needs a machine ([STATE.md:417-427](../../../../docs/superpowers/plans/STATE.md)):
...
([STATE.md:436-438](../../../../docs/superpowers/plans/STATE.md)). The rivet itself comes off the
...
made of ([STATE.md:458-476](../../../../docs/superpowers/plans/STATE.md), row *bending roller → iiex*):
...
([STATE.md:433-434](../../../../docs/superpowers/plans/STATE.md)).
...
|---|---|---|
| Network | `"mpenergy"`, an `IMpEnergyConsumer` | [STATE.md:455](../../../../docs/superpowers/plans/STATE.md) |
...
| Tooling | one roll-set-shaped item selecting the roll geometry, in the established `rollset` / `pattern` / `ItemDie` idiom | [STATE.md:430-432](../../../../docs/superpowers/plans/STATE.md) |
...
([STATE.md:425-432](../../../../docs/superpowers/plans/STATE.md); `skelp`'s geometry and mass at [rolled-parts](../items/rolled-parts.md).)

Four jobs instead of one is what justifies building it - pipe alone never did
([STATE.md:432-433](../../../../docs/superpowers/plans/STATE.md)).
...
a cupola, fabricate when you have a mill" ([STATE.md:234-236](../../../../docs/superpowers/plans/STATE.md)) only works if the two
...
* The settled placement is iiex ([STATE.md:476](../../../../docs/superpowers/plans/STATE.md)), and the machine is the general
...
* hpex's rolled pipe tier is uncraftable - B5: four live blocktypes, four shapes, zero recipes
  ([STATE.md:52](../../../../docs/superpowers/plans/STATE.md)). The skelp → segment → bell-weld → rolled pipe chain through this
...
| 8 | A powered riveter as a later throughput upgrade is explicitly allowed but undesigned ([STATE.md:437-438](../../../../docs/superpowers/plans/STATE.md)) | — |
