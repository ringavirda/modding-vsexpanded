...
| the cold blast furnace's ferroalloy second act - burden family, coke cost, the fuel-against-throughput trade | [cold blast furnace](blast-furnace-cold.md), [STATE.md § the ferroalloy furnace](../../../../docs/superpowers/plans/STATE.md) |
| melting a ferroalloy for the ladle | [cupola](cupola.md) |
| alloying in the bath vs in the ladle (D6) | [STATE.md § D6](../../../../docs/superpowers/plans/STATE.md) |
...
| the HP machines that consume bearings | [hp hammer](hp-hammer.md), [STATE.md](../../../../docs/superpowers/plans/STATE.md) |
...
[STATE.md § N2](../../../../docs/superpowers/plans/STATE.md)
...
([STATE.md:477-479](../../../../docs/superpowers/plans/STATE.md)).
...
and nails ([STATE.md:481-484](../../../../docs/superpowers/plans/STATE.md)). The die is the whole difference, the same argument that
...
Naming. [STATE.md:481](../../../../docs/superpowers/plans/STATE.md) says *"give the cutter bench a ball die"*, which is ambiguous
...
invalidated ([STATE.md:486-488](../../../../docs/superpowers/plans/STATE.md)). Line shafting, mill stands and beam engines ran on
...
|---|---|---|---|
| **balls** | chrome-steel rod @ 25 u → *n* balls | [heading machine](heading-machine.md) + the ball die | iiex ships the bench, hpex ships the die ([STATE.md:583](../../../../docs/superpowers/plans/STATE.md)) |
| **race** | a rolled ring | [bending roller](bending-roller.md) | iiex |
| assembly | balls + race → bearing | a grid recipe | hpex |

Both parts are products the forming line already makes ([STATE.md:483-484](../../../../docs/superpowers/plans/STATE.md)). No new
...
[STATE.md:483-484](../../../../docs/superpowers/plans/STATE.md) settles it as rolled, and this page follows that. The open work is
which tool.
...
([STATE.md:322-324](../../../../docs/superpowers/plans/STATE.md), [cold blast furnace § second act](blast-furnace-cold.md)). The
...
Break 2 - the requirement stops at the Corliss. [STATE.md:467](../../../../docs/superpowers/plans/STATE.md) requires bearings for
...
* Do not retrofit. No existing recipe gains a bearing. Journal bearings are abstracted into build cost
  ([STATE.md:486-488](../../../../docs/superpowers/plans/STATE.md)); adding one to an iiex machine would invalidate saves.
...
* The rod route is blocked upstream (B4). `grooved`'s first gap is 1.0 against 3.0 stock, a 2.0 draft against
  `δ_max` 1.0, so no rod can be made at all today ([STATE.md:51](../../../../docs/superpowers/plans/STATE.md),
...
| 3 | One race or two? [STATE.md:483](../../../../docs/superpowers/plans/STATE.md) says *"balls + a rolled ring race"*, singular. A real bearing has an inner and an outer. Singular is simpler and is the settled text; two is the honest engineering. Pick and write it down | yes |
