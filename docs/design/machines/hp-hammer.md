...
| the placement rule that assigns machines to mods | [STATE.md § placement rule](../../../../docs/superpowers/plans/STATE.md) |
...
inherits) · [materials.md](../materials.md) · [STATE.md](../../../../docs/superpowers/plans/STATE.md)
...
([STATE.md § placement rule](../../../../docs/superpowers/plans/STATE.md)) a machine lives with the content it makes possible, and
...
cast-iron ↔ fabricated-steel substitution ([STATE.md § N3](../../../../docs/superpowers/plans/STATE.md)), is mandatory rather than
...
| A hard material lockout contradicts the settled alloy rule. D3/R5 settled that alloys inherit their base's grade as a continuous penalty, not a lockout - critical machinery built from lesser steel gets a lower max pressure | [STATE.md § D3](../../../../docs/superpowers/plans/STATE.md) |
...
* The rolled pipe tier is uncraftable (B5) - four live blocktypes, four shapes, zero recipes
  ([STATE.md:52](../../../../docs/superpowers/plans/STATE.md); `mods/siex/src/Recipes/` contains exactly one file). So an
