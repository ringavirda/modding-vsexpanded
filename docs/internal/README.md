...
| [2026-09-06-extools-repo.md](plans/2026-09-06-extools-repo.md) | the CLI, the packaging build and the verify tool in their own repository, consumed through two checked-in wrappers and a pinned version | complete 2026-09-07; pushes pending (restructure step 4) |
